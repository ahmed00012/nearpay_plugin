...
//                        val map: Map<String, Any> = gson.fromJson(jsonString, object : TypeToken<Map<String, Any>>() {}.type)
                        ...
                        sendPurchaseEvent(transactionUuid, "sendTransactionCompleted", null, map)
                    }
    ...
    private fun sendPurchaseEvent(
        ...
        try {
            ...
            Timber.e(
                e,
                "Failed to send purchase event: $eventType for transactionUuid: $transactionUuid with error: ${e.message}"
            )
            throw e;
        }
    }

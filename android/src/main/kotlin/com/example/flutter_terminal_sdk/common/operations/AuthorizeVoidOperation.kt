...
import io.nearpay.terminalsdk.data.dto.VoidResponse
...
class VoidAuthorizationOperation(provider: NearpayProvider) : BaseOperation(provider) {
    ...
    override fun run(filter: ArgsFilter, response: (Map<String, Any>) -> Unit) {
        ...
        val id = filter.getString("id")
            ?: return response(ResponseHandler.error("MISSING_ID", "Id is required"))
        ...
        terminal?.voidAuthorization(
            ...
            voidListener = object : io.nearpay.terminalsdk.listeners.VoidListener {
                ...
                override fun onVoidCompleted(voidResponse: VoidResponse) {
